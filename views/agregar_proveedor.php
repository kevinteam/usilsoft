            ...
            <div class="main">
                <section id="content">
                    <div class="bg">
                        <div class="padding">
                            <div class="wrapper">
                                <form id="proveedor" name="proveedor" action="../controllers/procesar_proveedor.php" method="post">
                                <fieldset>
                                <legend>Ingresar Proveedor</legend>     
                                 <label for="nombre"> Nombre : </label>
                                 <input type="text" name="nombre" id="nombre" placeholder="Ingrese el nombre del proveedor" required/>
                                 <br>
                                <label for="ruc"> RUC : </label>
                                <input type="text" name="ruc" id="ruc" placeholder="Ingrese el RUC" required/>
                                <br>
                                <label for="direccion"> Dirección : </label>
                                 <input type="text" name="direccion" id="direccion" placeholder="Ingrese el nombre del proveedor" required/>
                                 <br>
                               <br>      
