                    ...
                    <div class="slider">
                        <ul class="items">
                            <li>
                                ...
                                <div class="banner">
                                    <strong class="title">
                                        <strong>Lista de </strong><em>Marcas</em>
                                    </strong>
                                    <p class="p3">Podra generar la lista de Marcas de forma dinamica.</p>
                                    <a class="button-1" href="orders_lists.php">Ir a Marcas</a>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="banner">
                                    <strong class="title">
                                        <strong>Creacion de</strong><em>marcas</em>
                                    </strong>
                                    <p>Podra crear Marcas automaticamente.</p>
                                    <a class="button-1" href="#">Ir a Marcas</a>
                                </div>
                            </li>
                            <li>
