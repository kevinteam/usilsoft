                        ...
                        <div class="padding">
                            <div class="wrapper">
                                <article class="col-1">
                                    ...
                                    <div class="relative">
                                        <a class="button-2" href="<?php echo $base_productos; ?>/views/lista_marcas.php">Ir a Marcas</a>
                                    </div>
                                </article>
                                <article class="col-1">
                                    ...
                                    <div class="relative">
                                        <a class="button-2" href="<?php echo $base_almacen; ?>/views/lista_proveedores.php">Ir a Proveedores</a>
                                    </div>
                                </article>
                                <article class="col-2">
                                    ...
                                    <div class="relative">
                                        <a class="button-2" href="<?php echo $base_productos; ?>/views/lista_productos.php">Ir a Productos</a>
                                    </div>
                                </article>
                            </div>
                        </div>
