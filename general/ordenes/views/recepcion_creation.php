        ...
        <div class="inner">
            <div class="main">
                <section id="content">
                    ...
                    <legend>Recepcion de Pedido Nuevo</legend>
                    <div class="indent">
                        <div class="wrapper">
                            <article class="col-1">
                                <p id="prinerror" style="color:red;"></p>
                                <div class="indent-left">
									<form action="recepcion_update.php" method="post">
										<div class="orderslist-col1">
											...
											<input type = "hidden" name = "fecha" value = "<?php echo $date2 ?>">
										</div>
										<div class="orderslist-col2">
											<div class="relative relative-center">
												<input class = "button-2" type= "submit" value = "Ingresar Pedido">
											</div>
										</div>
									</form>
                                </div>
                            ...
                            <article class="col-2">
                                <h3 class="border-bot">Fecha de Recepcion</h3>
