<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if($logeado)
        {
            ...
            $sql = "SELECT SQL_CALC_FOUND_ROWS * FROM Orders, Suppliers, States WHERE Orders.supplierID = Suppliers.supplierID AND Orders.stateID = States.stateID AND Orders.creationDate >= '$fechainicialformateada' AND Orders.creationDate <= '$fechafinalformateada' ORDER BY Orders.orderID ASC LIMIT $offset, $limit";
            ...
            header("Location: ".$base_ordenes."/views/orders_lists.php?page=".$page."&key=".$key);
            exit();
        }
        else
        {
